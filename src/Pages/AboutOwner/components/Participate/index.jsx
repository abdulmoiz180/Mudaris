  ...
  return (
    <section className="participate-container row">
      <Box className="participate-heading center">
        <h2 className="inter">How to Participate in This Course</h2>
      </Box>
      <Box className="participate-cards row">
        <div className="participate-card  row">
          <div className="participate-card-title row">
            <h2 className="card-title-number purple barlow">01</h2>
            <span className="p-card-heading">
              <h2 className="card-title-name purple">Course Registration</h2>
            </span>
          </div>
        ...
        <div className="participate-card  row">
          <div className="participate-card-title row">
            <h2 className="card-title-number purple barlow">02</h2>
            <span className="p-card-heading">
              <h2 className="card-title-name purple">
        ...
        <div className="participate-card row">
          <div className="participate-card-title row">
            <h2 className="card-title-number purple barlow">03</h2>
            <span className="p-card-heading">
              <h2 className="card-title-name purple">Requirements</h2>{" "}
            </span>
          </div>
          <p>
          ...
          <ul className="participate-li">
            ...
            <li className="inter ">Entrepreneurial mindset</li>
            <li className="inter ">
              Basic understanding of the digital age, economics, and finance
            </li>
            <li className="inter ">Familiarity with basic computer programs</li>
            <li className="inter ">Strong analytical and creative thinking</li>
            <li className="inter ">

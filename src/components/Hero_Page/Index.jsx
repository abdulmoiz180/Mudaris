      ...
      <Box className='ContainerContent'>
        <Card className='card'>
          <CardContent className='cardText inter'>
            <Typography variant='p' className='NewText inter'>NEW</Typography>
            <Typography variant='p inter'>Latest Recommendation</Typography>
          </CardContent>
        </Card>
        <Box className='ContainerText'>
          ...
          <button onClick={videoPlay} className='inter'>{video ? "Pause Video" : "Play Video"}</button>

...
<p className="getajob-qa dm-sans">{pickData.descriptionquestion1}</p>
<p className="getajob-qa dm-sans">{pickData.descriptionquestion2}</p>
...
<div className="getajob-para">
<p className="getajob-knwothat dm-sans">{pickData.descriptionparaknowthat1}</p>
<p className="getajob-knwothat dm-sans">{pickData.descriptionparaknowthat2}</p>
</div>
</div>

<div className="getajob-circle">
<Spline
scene="https://prod.spline.design/37l9lw5REBf6fMtO/scene.splinecode" 
/>
</div>
